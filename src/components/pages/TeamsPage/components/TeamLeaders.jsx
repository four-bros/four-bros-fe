            ...
            {leaders.passing.length > 0 && (
                <TableContainer title='Passing'>
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ? getPassingInfo(getTopThree(leaders.passing))
            ...
            {leaders.rushing.length > 0 && (
                <TableContainer title='Rushing'>
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ? getRushingInfo(getTopThree(leaders.rushing))
            ...
            {leaders.defense.length > 0 && (
                <TableContainer title='Defense'>
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ? getDefendingInfo(getTopThree(leaders.defense))
                    ...
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ...
                                : getKickReturnsInfo(leaders.kick_return)
                        }
                    />
                </TableContainer>
            )}
                    ...
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ...
                                : getPuntReturnsInfo(leaders.punt_return)
                        }
                    />
                </TableContainer>
            )}
            ...
            {leaders.kicking.length > 0 && (
                <TableContainer title='Kicking'>
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ? getKickingInfo(getTopThree(leaders.kicking))
            ...
            {leaders.punting.length > 0 && (
                <TableContainer title='Punting'>
                    <LargeTable
                        ...
                        contents={
                            infoType === 'overview'
                                ? getPuntingInfo(getTopThree(leaders.punting))
